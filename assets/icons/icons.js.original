/* ============================================
   NG Doce Duo — Ícones (linha única, estilo Lucide, traço 1.5)
   Uso: NG.icon("cart", { size:24, label:"Sacola" })
   ============================================ */
(function (NG) {
  "use strict";
  ...
  const P = {
    ...
    truck: '<path d="M14 18V6a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h1"/><path d="M15 18h-5"/><path d="M18 18h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.62l-3.48-4.35A1 1 0 0 0 16.52 8H14"/><circle cx="7" cy="18" r="2"/><circle cx="17" cy="18" r="2"/>',
    ...
    pix: '<path d="M12 2 2 12l10 10 10-10Z"/><path d="M8 12h8"/>',
    ...
    star: '<path d="M11.5 2.5 14 8l6 .5-4.5 4 1.5 6-5.5-3.5L6.5 18.5l1.5-6L3.5 8.5 9.5 8Z"/>',
  ...
  NG.icon = function (name, opts) {
    ...
    return `<svg${cls} width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"${aria}>${path}</svg>`;
  };
})((window.NG = window.NG || {}));
